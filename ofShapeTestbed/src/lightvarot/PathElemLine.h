#ifndef PATHELEMLINE_H_
#define PATHELEMLINE_H_

#include "PathElem.h"
#include "MPoint.h"

class PathElemLine : public PathElem
{
public:
	MPoint<float>			_st;
	MPoint<float>			_en;
	...
	PathElemLine();
	PathElemLine(MPoint<float> const &st, MPoint<float> const &en, Path* dad);
	PathElemLine(PathElemLine const &o);
	virtual ~PathElemLine();
